...
function warnTheSheep(queue) {
    // reverse array method to change order of elements in the array
    // indexOf array method will give index of selected element
    const sheep = queue.reverse().indexOf('wolf')
    // ternary operator to index of wolf is equal to 0
